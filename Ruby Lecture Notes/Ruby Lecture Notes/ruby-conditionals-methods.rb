...
# Every 'if' needs an 'end'
    # two different ends means two difference execution layers of code
...
# .chomp - removes the /n line break character 
...
user_age = gets.chomp.to_i # .to_i --> converts a string into an integer
p user_age
